...
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: ccbce539eb907b705215af3625270a8c)
// Runtime types generated with workerd@1.20260310.1 2026-03-23
...
> =
	...
	: T extends (
		Exclude<Rpc.EntrypointBranded, Rpc.WorkerEntrypointBranded>
	) ?
		never
	:	Fetcher<undefined>;
type Fetcher<
...
declare namespace Rpc {
	...
	type MaybeCallableProvider<T> =
		T extends (...args: any[]) => any ? MethodOrProperty<T>
		:	unknown;
	...
	type Exports = {
		[K in keyof MainModule]: LoopbackForExport<MainModule[K]> &
			...
			(K extends GlobalProp<"durableNamespaces", never> ?
				MainModule[K] extends (
					new (...args: any[]) => infer DoInstance
				) ?
					DoInstance extends (
