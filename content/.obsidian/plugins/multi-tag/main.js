...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      option0.selected = option0_selected_value = /*option*/ ctx[1] === "inline"
      option1.__value = "yaml"
      set_input_value(option1, option1.__value)
      option1.selected = option1_selected_value = /*option*/ ctx[1] === "yaml"
      if (
        /*option*/
        ctx[1] === void 0
      )
    ...
    p(new_ctx, [dirty]) {
      ...
      if (
        dirty /*option*/ & 2 &&
        option0_selected_value !== (option0_selected_value = /*option*/ ctx[1] === "inline")
      ) {
        option0.selected = option0_selected_value
      }
      if (
        dirty /*option*/ & 2 &&
        option1_selected_value !== (option1_selected_value = /*option*/ ctx[1] === "yaml")
      ) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("closeModal" in $$props2) $$invalidate(2, (closeModal = $$props2.closeModal))
    if ("submission" in $$props2) $$invalidate(4, (submission = $$props2.submission))
  }
  return [
    value,
    option,
