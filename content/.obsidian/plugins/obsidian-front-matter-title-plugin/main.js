...
var Target = (function () {
  function Target2(type, identifier, serviceIdentifier, namedOrTagged) {
    ...
    this.serviceIdentifier = serviceIdentifier
    var queryableName =
      typeof identifier === "symbol" ? getSymbolDescription(identifier) : identifier
...
function getTargets(metadataReader, constructorName, func, isBaseClass) {
  ...
  var iterations =
    hasUserDeclaredUnknownInjections || hasOptionalParameters ? keys.length : func.length
...
function isPromise(object) {
  var isObjectOrFunction =
    (typeof object === "object" && object !== null) || typeof object === "function"
        ...
        case 2:
          ...
          return [
            ...
            createInstanceWithInjections(
              __assign(__assign({}, args), { constructorInjections, propertyInjections }),
            ),
          ]
      }
    })
...
function isClonable(obj) {
  return (
    typeof obj === "object" && obj !== null && "clone" in obj && typeof obj.clone === "function"
  )
}
...
var Container = (function () {
  ...
  Container3.merge = function (container1, container2) {
    ...
    var targetContainers = __spreadArray3([container1, container2], containers, true).map(
  ...
  Container3.prototype._propagateContainerDeactivationThenBindingAndPreDestroy = function (
    binding,
    instance2,
    constructor,
  ) {
  ...
  Container3.prototype._propagateContainerDeactivationThenBindingAndPreDestroyAsync = function (
    binding,
    instance2,
    constructor,
  ) {
...
var Translator = class _Translator extends EventEmitter {
  ...
  translate(keys, options, lastKey) {
    ...
    const returnDetails =
      options.returnDetails !== void 0 ? options.returnDetails : this.options.returnDetails
    const keySeparator =
      options.keySeparator !== void 0 ? options.keySeparator : this.options.keySeparator
...
Simple = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["factory:placeholder"]))],
  Simple,
)
...
var HeadingPlaceholder = class extends AbstractPlaceholder {
  ...
  makeValue(path) {
    var _a, _b, _c
    return (_c =
      (_b = (_a = this.factory(path, "headings")) == null ? void 0 : _a[0]) == null
        ? void 0
        : _b.heading) != null
      ? _c
      : ""
...
HeadingPlaceholder = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["factory:obsidian:meta"]))],
  HeadingPlaceholder,
)
...
var ExplorerSort = class {
  ...
  initView() {
    var _a, _b
    this.view =
      (_b = (_a = this.facade.getViewsOfType("file-explorer" /* FE */)) == null ? void 0 : _a[0]) !=
      null
        ? _b
        : null
  }
  tryToReplaceOriginalSort() {
    ...
    this.replacer = this.replacerFactory(
      ...
      (feature, defaultArgs, vanilla) => {
        var _a
        return (_a = feature.getSortedFolderItems(defaultArgs == null ? void 0 : defaultArgs[0])) !=
          null
          ? _a
          : vanilla.call(this)
      },
    ...
    for (const i of ids) {
      ...
      if (manager) {
        promises.push(
          manager
            .refresh()
            .then(() => this.dispatcher.dispatch("manager:refresh", new Event({ id: i }))),
        )
      }
    }
    await Promise.all(promises)
...
var SearchManager = class extends AbstractFeature {
  ...
  isLeafActive() {
    var _a, _b
    return (_b = (_a = this.facade.getLeavesOfType("search" /* S */)) == null ? void 0 : _a[0]) ==
      null
      ? void 0
      : _b.isVisible()
  }
  getView() {
    var _a, _b
    return (_b = (_a = this.facade.getViewsOfType("search" /* S */)) == null ? void 0 : _a[0]) !=
      null
      ? _b
      : null
  }
...
var TabManager = class extends AbstractManager {
  ...
  initReplacer() {
    ...
    this.replacer = FunctionReplacer.create(
      ...
      function (self2, [pinned], vanilla) {
        ...
        if (
          ((_a = this == null ? void 0 : this.view) == null ? void 0 : _a.getViewType()) ===
          "markdown" /* MD */
        ) {
  ...
  async innerUpdate(path = null) {
    ...
    for (const leaf of leaves) {
      const filePath =
        (_b = (_a = leaf.view) == null ? void 0 : _a.getState()) == null ? void 0 : _b.file
...
AbstractStrategy = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["feature:service"]))],
  AbstractStrategy,
)
...
var BookmarksManager = class extends AbstractFeature {
  ...
  tryEnable(subscribeOnActive = false) {
    var _a
    const leaf =
      (_a = this.facade.getLeavesOfType("bookmarks" /* Bookmarks */)) == null ? void 0 : _a[0]
    if (leaf.isVisible()) {
  ...
  initView() {
    ...
    const view =
      (_b =
        (_a = this.facade.getViewsOfType("bookmarks" /* Bookmarks */)) == null ? void 0 : _a[0]) !=
      null
        ? _b
        : null
    if (view === null) {
  ...
  onChanged(path = null) {
    ...
    for (const item of items) {
      ...
      if (
        titleEl &&
        item.type === "file" &&
        (item.title === "" || (item == null ? void 0 : item.title) === void 0) &&
        (!path || item.path === path)
      ) {
...
var GraphManager = class extends AbstractManager {
  ...
  async doUpdate(path) {
    ...
    let result = false
    for (const view of this.getViews()) {
      for (const node of (_b = (_a = view.renderer) == null ? void 0 : _a.nodes) != null
        ? _b
        : []) {
        if (node.id === path) {
          result = true
  ...
  getFirstNode() {
    ...
    for (const view of this.getViews()) {
      const node =
        (_c = (
          (_b = (_a = view.renderer) == null ? void 0 : _a.nodes) != null ? _b : []
        ).first()) != null
          ? _c
          : null
      if (node) {
...
FeatureService = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["resolver:service"]))],
  FeatureService,
)
...
var NoteLinkFeature = class extends AbstractFeature {
  ...
  async executeChanges(path, changes) {
    ...
    let content =
      file instanceof import_obsidian6.TFile ? await this.facade.getFileContent(file) : null
    if (!content) {
      return
    }
...
NoteLinkApprove = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["factory:obsidian:modal"]))],
  NoteLinkApprove,
)
...
AliasConfig = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["settings:storage"]))],
  AliasConfig,
)
...
ExplorerFileItemMutator = __decorateClass([injectable()], ExplorerFileItemMutator)
    ...
    new import_obsidian10.Setting(this.container)
      ...
      .addText((text) => {
        ...
        return text
          ...
          .setValue((_a = this.item.get("common").get("main").value()) != null ? _a : "")
  ...
  buildFallbackTemplate() {
    new import_obsidian10.Setting(this.container)
      ...
      .addText((text) => {
        ...
        return text
          .setPlaceholder(t2("template.placeholder"))
          .setValue((_a = this.item.get("common").get("fallback").value()) != null ? _a : "")
...
RulesBuiler = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["factory:settings:builder"]))],
  RulesBuiler,
)
...
var FeaturesBuilder = class extends AbstractBuilder2 {
  ...
  doBuild() {
    ...
    for (const item of data) {
      const builder =
        (_a = this.builderFactory(item.feature)) != null ? _a : this.builderFactory("default")
...
var RulesDelimiterBuilder = class extends AbstractBuilder2 {
  ...
  buildDropdown() {
    ...
    new import_obsidian12.DropdownComponent(this.setting.controlEl)
      .addOptions({ N: t2("rule.delimiter.first"), Y: t2("rule.delimiter.join") })
...
var RulesPathsBuilder = class extends AbstractBuilder2 {
  ...
  doBuild() {
    this.settings = new import_obsidian13.Setting(this.container)
      ...
      .addDropdown((e) =>
        e
          .addOptions({ white: t2("rule.path.white.name"), black: t2("rule.path.black.name") })
      ...
      return c
        ...
        .onChange((v) => {
          ...
          this.item
            .get("args")
            .set([
              ...((_b = (_a2 = this.lastArgs) == null ? void 0 : _a2[value]) != null ? _b : []),
            ])
        ...
        createDiv(
          ...
          (e) => {
            ...
            new import_obsidian14.TextComponent(e)
              .setValue((_a = value == null ? void 0 : value[i]) != null ? _a : "")
    ...
    new import_obsidian15.Setting(el)
      ...
      .addDropdown((e) => {
        ...
        e.addOptions({
          ...
          .setValue((_a = this.config.strategy) != null ? _a : "onlyEmpty" /* OnlyEmpty */)
          .onChange((v) => {
...
var settings_config_default = (c) => {
  ...
  c.bind(inversify_types_default["factory:settings:feature:builder"]).toFunction((name) =>
  ...
  c.bind(inversify_types_default["factory:settings:builder"]).toFunction((name) =>
...
ReplaceProcessor = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["processor:args"]))],
  ReplaceProcessor,
)
...
ProcessorArgumentTransformer = __decorateClass([injectable()], ProcessorArgumentTransformer)
...
var Resolver = class {
  ...
  get(path) {
    var _a
    try {
      return (_a = this.dispatch(this.creator.create(path, this.template), path)) != null
        ? _a
        : null
    } catch (e) {
...
var resolver_config_default = new ContainerModule((bind) => {
  bind(inversify_types_default["factory:resolver:template"]).toFactory((c) => (value) => {
    ...
    const targetTemplates =
      (_a = storage.get("features").get(name)) == null ? void 0 : _a.get("templates")
    const template =
      (_b = targetTemplates == null ? void 0 : targetTemplates.get(type)) == null
        ? void 0
        : _b.value()
...
Defer = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["factory:api"]))],
  Defer,
)
...
PathListFilter = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["component:black_white_list"]))],
  PathListFilter,
)
...
ArrayStrategy = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["getter:delimiter"]))],
  ArrayStrategy,
)
...
FileNoteLinkService = __decorateClass(
  [injectable(), __decorateParam(0, inject(inversify_types_default["facade:obsidian"]))],
  FileNoteLinkService,
)
...
var EventDispatcher = class {
  ...
  addListener({ name, cb, sort = null, once = false }) {
    ...
    sort =
      sort != null
        ? sort
        : ((_c = (_b = events[0]) == null ? void 0 : _b.sort) != null ? _c : 0) + 1
  ...
  dispatch(name, e) {
    ...
    let shift = 0
    for (const [i, item] of [
      ...((_b = (_a = this.events.get(name)) == null ? void 0 : _a.entries()) != null ? _b : []),
    ]) {
      item.cb(e)
      if (item.once) {
...
var BlackWhiteListListener = class {
  ...
  handle({ changed, actual }) {
    var _a, _b, _c, _d
    if (
      (_b = (_a = changed == null ? void 0 : changed.rules) == null ? void 0 : _a.paths) == null
        ? void 0
        : _b.values
    ) {
    ...
    if (
      (_d = (_c = changed == null ? void 0 : changed.rules) == null ? void 0 : _c.paths) == null
        ? void 0
        : _d.mode
    ) {
...
FakeTitleElementService = __decorateClass([injectable()], FakeTitleElementService)
...
var ResultDomWrapper = class {
  ...
  processLookupItem(file, item) {
    ...
    const text =
      (_b = restore ? null : this.resolver.resolve(file.path)) != null ? _b : file.basename
...
Container2.bind(inversify_types_default["factory:replacer"]).toFunction((t3, m, a, i) =>
  FunctionReplacer.create(t3, m, a, i),
)
...
var ObsidianFacade = class {
  ...
  getActiveFile() {
    var _a, _b
    return (_b = (_a = this.app.workspace) == null ? void 0 : _a.getActiveFile()) != null
      ? _b
      : null
  }
  getWorkspace() {
    ...
    if (Array.isArray((_a = this.config) == null ? void 0 : _a.templates)) {
      this.config.templates = {
        common: {
          main:
            (_d =
              (_c = (_b = this.config) == null ? void 0 : _b.templates) == null ? void 0 : _c[0]) !=
            null
              ? _d
              : PluginHelper.createDefaultSettings().templates.common.main,
          fallback:
            (_g =
              (_f = (_e = this.config) == null ? void 0 : _e.templates) == null ? void 0 : _f[1]) !=
            null
              ? _g
              : "",
        },
