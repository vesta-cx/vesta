...
- [[./pricing-modular.md|Modular Pricing & Weighted Discount Curve]] — Discount curve math and formulas
- [[./feature-access-gating.md|Feature Access & Gating]] — Feature access control and JWT strategy
- [[./milestones.md|Milestone 1 Roadmap (Blogging + Smart Links)]] — Milestone scope and scheduling
- [[../../apps/erato/Model/features-subscriptions.md|Features & Subscriptions]] — Data model and schema
