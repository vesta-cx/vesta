...
- [Feature Catalog & Pricing Transparency](./feature-catalog.md) — Complete feature list with COO, base prices, and tier assignments
- [Feature Access & Gating](./feature-access-gating.md) — Feature registry and access control
- [Milestone 1 Roadmap (Blogging + Smart Links)](./milestones.md) — Phase 1 features and feature tiers
- [Erato](../../apps/erato/index.md) — Data model (may need to extend for subscriptions)
