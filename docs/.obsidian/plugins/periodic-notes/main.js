...
function getDailyNotesPlugin() {
  ...
  return (_a = internalPlugins.getPluginById("daily-notes")) === null || _a === void 0
    ? void 0
    : _a.instance
}
...
function hasLegacyWeeklyNoteSettings() {
  ...
  return !!(options.weeklyNoteFormat || options.weeklyNoteFolder || options.weeklyNoteTemplate)
}
function getLegacyWeeklyNoteSettings() {
  ...
  return {
    ...
    template:
      ((_b = options.weeklyNoteTemplate) === null || _b === void 0 ? void 0 : _b.trim()) || "",
  }
}
function isMacOS() {
...
function create_fragment$4(ctx) {
  ...
  let if_block2 =
    !(/*hasDailyNoteSettings*/ ctx[3]) && !(/*hasWeeklyNoteSettings*/ ctx[4]) && create_if_block$4()
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props) => {
    ...
    if ("migrateDailyNoteSettings" in $$props)
      $$invalidate(2, (migrateDailyNoteSettings = $$props.migrateDailyNoteSettings))
  }
  ...
  return {
    ...
    p(ctx, [dirty]) {
      if (
        dirty & /*value*/ 4 &&
        t5_value !==
          (t5_value = window.moment().format(/*value*/ ctx[2] || /*defaultFormat*/ ctx[8]) + "")
      )
...
function instance($$self, $$props, $$invalidate) {
  ...
  const click_handler = (periodicity) => {
    set_store_value(
      settingsStore,
      ($settingsStore[periodicity].enabled = !$settingsStore[periodicity].enabled),
      $settingsStore,
    )
  }
...
class PeriodicNotesPlugin extends obsidian.Plugin {
  ...
  configureRibbonIcons() {
    ...
    const configuredPeriodicities = ["daily", "weekly", "monthly", "quarterly", "yearly"].filter(
    ...
    if (configuredPeriodicities.length) {
      ...
      this.ribbonEl = this.addRibbonIcon(
        ...
        (event) => openPeriodicNote(periodicity, window.moment(), isMetaPressed(event)),
      )
