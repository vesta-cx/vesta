...
See [Permissions](../access/permissions.md) for the full precedence model.
...
When a user joins a team, they immediately inherit all the team's permissions via the [Permissions](../access/permissions.md) model.
...
3. Apply permission precedence logic (see [Permissions](../access/permissions.md#permission-precedence-highest-to-lowest))
...
See [Permissions](../access/permissions.md#permission-merger-core-implementation) for the implementation.
...
- [Permissions](../access/permissions.md) — Full permission model with precedence rules
