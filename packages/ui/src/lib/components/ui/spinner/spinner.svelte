...
<style>
	...
	.windows-spinner__arc {
		...
		--spinner-back: 0;
		animation:
			windows-spinner-front var(--spinner-duration) cubic-bezier(0.33, 1, 0.68, 1) infinite,
			windows-spinner-back var(--spinner-duration) cubic-bezier(0.32, 0, 0.67, 0) infinite;
		stroke: currentColor;
